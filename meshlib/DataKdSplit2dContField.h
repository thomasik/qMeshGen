...
#ifndef DATAKD2DSPLITCF_H__INCLUDED
#define DATAKD2DSPLITCF_H__INCLUDED
...
class Kd2dSplitterContField : public Kd2dSplitter
{
public:
	Kd2dSplitterContField(int _csize = 0) : Kd2dSplitter(_csize) { }
public:
	virtual void whereToSplit(const DRect & box,
		CDM2d(*f)(const DPoint2d & pt),
...
*/
class Kd2dCFHalfLongestSplitter : public Kd2dSplitterContField
{
public:
	void whereToSplit(const DRect & box, CDM2d(* /* f */)(const DPoint2d & pt),
...
*
*/
class Kd2dCFMaxGradientSumSplitter : public Kd2dSplitterContField
{
public:
	Kd2dCFMaxGradientSumSplitter(int _samples_size = 4) : Kd2dSplitterContField(_samples_size) {
...
class Kd2dCFMaxGradientSplitter : public Kd2dSplitterContField
{
public:
	Kd2dCFMaxGradientSplitter(int _samples_size = 4) : Kd2dSplitterContField(_samples_size) {
		assert(_samples_size > 1);
	}
public:
	void whereToSplit(const DRect &box, CDM2d (*f)(const DPoint2d & pt),
...
class Kd2dCFMaxDiffGradientSplitter : public Kd2dSplitterContField
{
public:
	Kd2dCFMaxDiffGradientSplitter(int _samples_size = 4) : Kd2dSplitterContField(_samples_size) {
		assert(_samples_size > 1);
	}
public:
	void whereToSplit(const DRect &box, CDM2d (*f)(const DPoint2d & pt),
...
#endif // !defined(DATAKD2DSPLITCF_H__INCLUDED)
