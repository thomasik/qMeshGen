...
print MAKEFILE "INST_DIR  = ../linux\n";
print MAKEFILE "CXXFLAGS  = -DUNIX_MODE -DNDEBUG -std=c++14 -pedantic -I../libboard -I../log4cplus-linux/include -Wall -W -Wconversion -Wshadow -Wcast-qual -Wwrite-strings -Wno-unknown-pragmas -Wno-char-subscripts\n";
...
print MAKEFILE 'default: $(INST_DIR)/$(MESHLIB)', "\n\n";
print MAKEFILE '$(INST_DIR)/$(MESHLIB): $(OBJS)';
print MAKEFILE "\n\tar rcs \$(INST_DIR)/\$(MESHLIB) \$(OBJS) \n\n";
print MAKEFILE "clean:\n\trm -f \$(OBJS) \$(INST_DIR)/\$(MESHLIB)\n\n";
